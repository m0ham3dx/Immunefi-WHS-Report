...
6. **Phase 6 - POC** - A critical step in making the project understand the impact of the finding. This step is often overlooked either due to negligence or <u>lack of technical ability</u>, to write a great **POC**. The latter issue can be rectified by learning how existing POC's for findings have ben written. This step is crucial in determining a **payout.**
...
# Common Vulnearbilities Vulnerabilities
## Ethereum - Solidity 
